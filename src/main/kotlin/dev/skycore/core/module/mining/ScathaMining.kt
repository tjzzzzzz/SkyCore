...
object ScathaMining {
    ...
    fun init() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register {
            ...
            spawnCooldown--
            if (spawnCooldown == 0 && active() && SkyCoreConfig.instance.scathaMining.cooldown) {
    ...
    fun onNamed(entity: Entity, name: Component) {
        ...
        seen.add(entity.id)
        if (SkyCoreConfig.instance.scathaMining.alert) {
    ...
    private fun active(): Boolean =
        SkyCoreConfig.instance.enabled &&
            SkyCoreConfig.instance.scathaMining.enabled &&
