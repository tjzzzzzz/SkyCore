...
object ChatWaypoints {
    ...
    fun init() {
        PartyChat.onMessage { msg ->
            if (!enabled() || !SkyCoreConfig.instance.chatWaypoints.partyEnabled || msg.self) return@onMessage
            parseCoords(msg.content, msg.sender, party = true)
        }

        ClientReceiveMessageEvents.GAME.register { message, overlay ->
            if (overlay || !enabled() || !SkyCoreConfig.instance.chatWaypoints.allEnabled) return@register
    ...
    private fun enabled(): Boolean =
        SkyCoreConfig.instance.enabled && SkyCoreConfig.instance.chatWaypoints.enabled
    ...
    private fun parseCoords(message: String, sender: String, party: Boolean) {
        ...
        for (raw in message.split(' ')) {
            ...
            if (coords.size == 3) {
                ...
                val cfg = SkyCoreConfig.instance.chatWaypoints
