...
object CommandShortcuts {
    ...
    fun init() {
        ClientCommandRegistrationCallback.EVENT.register { dispatcher, _ ->
            if (!SkyCoreConfig.instance.commandShortcuts.enabled) return@register
            for (entry in SkyCoreConfig.instance.commandShortcuts.shortcuts) {
    ...
    fun shortcuts(): MutableList<SkyCoreConfig.CommandShortcutEntry> =
        SkyCoreConfig.instance.commandShortcuts.shortcuts
}
