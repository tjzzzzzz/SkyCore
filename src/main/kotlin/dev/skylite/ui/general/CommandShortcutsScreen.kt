...
class CommandShortcutsScreen(private val parent: Screen?) : Screen(Component.literal("Command Shortcuts")) {
    ...
    private val shortcuts get() = SkyLiteConfig.instance.commandShortcuts.shortcuts
    ...
    private fun drawRow(
        ...
        entry: SkyLiteConfig.CommandShortcutEntry,
        index: Int,
        x: Int,
        y: Int,
        w: Int,
    ...
    override fun mouseClicked(event: MouseButtonEvent, doubleClick: Boolean): Boolean {
        ...
        if (Ui.inBounds(event.x, event.y, panelX + panelW - PAD - addW, panelY + 12, addW, BTN_H)) {
            shortcuts.add(SkyLiteConfig.CommandShortcutEntry())
            SkyLiteConfig.save()
            return true
        }
        val backW = Fonts.width(BACK) + 24
