...
class CommandKeybindsScreen(private val parent: Screen?) : Screen(Component.literal("Command Keybinds")) {
    ...
    private var editing: SkyLiteConfig.CommandBind? = null
    ...
    private fun drawRow(
        ...
        bind: SkyLiteConfig.CommandBind,
        index: Int,
        x: Int,
        y: Int,
        w: Int,
    ...
    private fun editorClick(event: MouseButtonEvent, bind: SkyLiteConfig.CommandBind): Boolean {
        focusedField = -1
        capturingKey = false
        var y = panelY + 48
    ...
    private fun openEditor(bind: SkyLiteConfig.CommandBind) {
        editing = bind
        nameBuf = bind.name
    ...
    private fun commitEditor(bind: SkyLiteConfig.CommandBind) {
        bind.name = nameBuf
