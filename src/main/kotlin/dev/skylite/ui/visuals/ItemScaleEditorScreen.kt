package dev.skylite.ui.visuals
...
/**
 * live first-person viewmodel editor.
 *
 * the world keeps rendering under a top panel so you can hold an item and see
 * every slider change immediately. esc writes the config and returns, same
 * contract as the hud editor.
 */
class ItemScaleEditorScreen(private val parent: Screen?) : Screen(Component.literal("Item Scale Editor")) {
    ...
    /** keep the world and held item fully visible under the panel */
    ...
    private fun testSwing() {
        ...
        // clear so Disable Re-Swing does not eat the preview click
