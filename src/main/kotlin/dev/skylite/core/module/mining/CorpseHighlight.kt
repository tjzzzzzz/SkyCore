...
object CorpseHighlight {
    ...
    fun init() {
        ...
        WorldBoxes.onRender { _, _ ->
            ...
            val hideOpened = SkyLiteConfig.instance.corpseHighlight.hideOpened
            for (id in stands) {
    ...
    fun onInteract(entity: Entity) {
        if (!active() || !SkyLiteConfig.instance.corpseHighlight.hideOpened) return
    ...
    private fun active(): Boolean =
        SkyLiteConfig.instance.enabled &&
            SkyLiteConfig.instance.corpseHighlight.enabled &&
