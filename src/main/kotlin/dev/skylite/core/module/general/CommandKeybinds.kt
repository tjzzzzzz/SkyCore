...
object CommandKeybinds {
    ...
    private val opts get() = SkyLiteConfig.instance.commandKeybinds
    ...
    fun binds(): MutableList<SkyLiteConfig.CommandBind> = opts.binds

    fun save() = SkyLiteConfig.save()

    fun addBind(): SkyLiteConfig.CommandBind {
        val bind = SkyLiteConfig.CommandBind()
        opts.binds.add(bind)
        save()
        return bind
    }
