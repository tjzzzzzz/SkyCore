package dev.skylite.core.render
...
object WorldBoxes {
    ...
    private val FILLED_THROUGH: RenderPipeline = RenderPipelines.register(
        RenderPipeline.builder(RenderPipelines.DEBUG_FILLED_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath("skylite", "pipeline/filled_through"))
    ...
    private val LINES_THROUGH: RenderPipeline = RenderPipelines.register(
        RenderPipeline.builder(RenderPipelines.LINES_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath("skylite", "pipeline/lines_through"))
            .withDepthStencilState(Optional.empty())
            .build()
    )

    private val vertexBuffer = StagedVertexBuffer({ "SkyLite WorldBoxes" }, RenderType.SMALL_BUFFER_SIZE)
